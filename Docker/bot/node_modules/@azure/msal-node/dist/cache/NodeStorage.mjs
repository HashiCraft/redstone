/*! @azure/msal-node v2.2.0 2023-10-05 */
'use strict';
import { CacheManager, AccountEntity, IdTokenEntity, AccessTokenEntity, RefreshTokenEntity, AppMetadataEntity, ServerTelemetryEntity, AuthorityMetadataEntity, ThrottlingEntity } from '@azure/msal-common';
...
class NodeStorage extends CacheManager {
    ...
    getServerTelemetry(serverTelemetrykey) {
        ...
        if (serverTelemetryEntity &&
            ServerTelemetryEntity.isServerTelemetryEntity(serverTelemetrykey, serverTelemetryEntity)) {
    ...
    getAuthorityMetadata(key) {
        ...
        if (authorityMetadataEntity &&
            AuthorityMetadataEntity.isAuthorityMetadataEntity(key, authorityMetadataEntity)) {
    ...
    getThrottlingCache(throttlingCacheKey) {
        ...
        if (throttlingCache &&
            ThrottlingEntity.isThrottlingEntity(throttlingCacheKey, throttlingCache)) {
